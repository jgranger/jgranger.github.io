...
export default function CitationsPage() {
  ...
  return (
    <div className="mx-auto max-w-[1600px] px-4 py-8 sm:px-6 sm:py-12 lg:flex lg:gap-12 lg:px-8 lg:py-16">
      <ChapterSidebar chapters={chapters} currentSlug="citations" />
